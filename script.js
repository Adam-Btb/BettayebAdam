...
listeCompetences.forEach(comp => {
    ...
    carte.className = `bg-cyber-gray border-2 border-dashed border-gray-700 rounded-lg flex flex-col items-center justify-center aspect-[5/4] hover:border-${hoverBordure} hover:bg-${hoverBordure}/10 transition-colors group`;
...
emplacementFutur.className = 'bg-cyber-gray/30 border-2 border-dashed border-gray-800 rounded-lg flex flex-col items-center justify-center aspect-[5/4] text-center opacity-50 hover:opacity-100 hover:border-cyber-purple transition-all duration-300';
...
const listeProjets = [
    ...
    },
    {
        ...
        badge:      "Data Viz",
        description: "Application interactive d'exploration des opinions climatiques en France basée sur les données du Baromètre ADEME. Intégration d'une carte SVG dynamique et génération de graphiques. (Non responsive, optimisé pour desktop)",
        tags:       [
    ...
    },
    {
        ...
        url:         "https://motusdragonballz.gamer.gd/"
    },
    {
        titre:      "DevFront : Intégration stricte",
        image:      "img/mockupfront.png",
        badge:      "Intégration",
        description: "Projet de démonstration d'intégration web \"pixel-perfect\". Validation des standards du W3C, structuration HTML5 sémantique et utilisation avancée de CSS3 pour des animations fluides. (Non responsive, optimisé pour desktop)",
        tags:       [
            { label: "HTML5",        cls: "text-orange-400 bg-orange-400/10" },
            { label: "CSS3",         cls: "text-blue-400 bg-blue-400/10" },
...
listeProjets.forEach(projet => {
    ...
    carte.innerHTML = `
        <div class="ouvrir-modale min-h-[180px] md:h-72 relative overflow-hidden border-b border-gray-700 bg-gray-900 p-4 cursor-pointer"
